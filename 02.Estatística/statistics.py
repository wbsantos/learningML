...
def margemErroMedia():
    ...
    alpha = 0.05
    mediaAmostral = 30
    E = Z(1 - alpha) * (desvioPadrao / (amostra ** (1/2))) 
    print(E) # 2.5477400397891516
    print(round(mediaAmostral - E, 2))
    print(round(mediaAmostral + E, 2))

def margemErroProporcao():
    amostra = 180
    p = 18.0/180.0
    alpha = 0.05
...
def tamanhoAmostralComVariancia():
    variancia = 0.1764 ** (1/2)
    E = 0.05
    alpha = 0.01
    n = ((Z(1 - alpha) * variancia) / E) ** 2
    print(n)
